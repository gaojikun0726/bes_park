 ...
 * @datetime 2018年5月15日
 */
public class ESUserRoleSjqxManage implements BaseEntity<Serializable>{

	private static final long serialVersionUID = 121231666523123123L;

	
	private String f_roleguid;// 用户角色编号
	private String f_qxbh;// 权限编号
	private String f_sjbh;// 数据编号
	private String f_sjmc;// 数据名称（此处不与数据表同步,权限显示用）
	...
	public void setF_roleguid(String f_roleguid) {
		this.f_roleguid = f_roleguid;
	}
