...
/**
 * @description 岗位数据权限管理
 * @author gongfanfei
 * @datetime 2018年5月15日
 */
public class ESUserPostSjqxManage implements BaseEntity<Serializable>{

	private static final long serialVersionUID = 121987623166123123L;

	
	private String f_gwguid;// 用户角色编号
