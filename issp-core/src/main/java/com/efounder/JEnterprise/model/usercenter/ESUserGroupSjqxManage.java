...
/**
 * @description 用户组数据权限管理
 * @author gongfanfei
 * @datetime 2018年5月15日
 */
public class ESUserGroupSjqxManage implements BaseEntity<Serializable>{

	private static final long serialVersionUID = 12123123123123L;

	
	private String f_zbh;// 用户组编号
