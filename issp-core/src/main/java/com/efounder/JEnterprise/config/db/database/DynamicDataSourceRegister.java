...
/**
 * 
 * 类名称：DynamicDataSourceRegister
 * 类描述：动态数据源注册<br/>启动动态数据源请在启动类中（如SpringBootSampleApplication）添加 @Import(DynamicDataSourceRegister.class)
 * 创建人：wujf
 * 修改人：wujf
 * 修改时间：2018年1月3日 上午11:49:36
 * 修改备注：
 * @version 1.0.0 
 *
 */
