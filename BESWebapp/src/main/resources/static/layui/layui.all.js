...
layui.define("jquery", function (e) {
    ...
    f.prototype.config = {
        ...
        if (t.input && !t.range) {
            var w = i('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div><div class="layui-icon percent" style="\n' +
                '    position: absolute;\n' +
                '    right: -3vh;\n' +
                '    top: -1.5vh;\n' +
                '">%</div>');
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    j.prototype.config = {
        ...
        i.layBody.on("change", "." + W, function () {
            var e = t(this), a = this.value,
                l = e.parent().data("field"),
                // 2020-11-24 查找指定上级 主要解决原查找最顶级导致bug问题
                n = parseInt(e.parent().parent().attr("data-index")),
                o = d.cache[i.key][n];
            //var arr = [d.cache[i.key], l, n, y, p, a, i.layBody,n!==d.cache[i.key].length-1,isEditListener]
            //console.log("查看新的", arr);
            if (!isEditListener||n>d.cache[i.key].length-1) {
                return;
            }
