...
function everyTime(dom) {
	var item = $("input[name=time_task_sync_" + dom.name + "]");
	item.val("*");
	item.change();
}
...
function unAppoint(dom) {
	...
	if (name == "year")
		val = "";
	var item = $("input[name=time_task_sync_" + name + "]");
	item.val(val);
	item.change();
}
...
$(function() {
	...
	var vals = $("input[name^='time_task_sync_']");
	var cron = $("#timeTaskSyncCron");
	...
	$("#time_task_sync_sencond_appoint").click(function(){
	    if (this.checked) {
	...
	secondList.change(function() {
		var time_task_sync_sencond_appoint = $("#time_task_sync_sencond_appoint").prop("checked");
		if (time_task_sync_sencond_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_second]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#time_task_sync_min_appoint").click(function(){
	    if (this.checked) {
	...
	minList.change(function() {
		var time_task_sync_min_appoint = $("#time_task_sync_min_appoint").prop("checked");
		if (time_task_sync_min_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_min]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#time_task_sync_hour_appoint").click(function(){
	    if (this.checked) {
	...
	hourList.change(function() {
		var time_task_sync_hour_appoint = $("#time_task_sync_hour_appoint").prop("checked");
		if (time_task_sync_hour_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_hour]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#time_task_sync_day_appoint").click(function(){
	    if (this.checked) {
	...
	dayList.change(function() {
		var time_task_sync_day_appoint = $("#time_task_sync_day_appoint").prop("checked");
		if (time_task_sync_day_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_day]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#time_task_sync_mouth_appoint").click(function(){
	    if (this.checked) {
	...
	mouthList.change(function() {
		var time_task_sync_mouth_appoint = $("#time_task_sync_mouth_appoint").prop("checked");
		if (time_task_sync_mouth_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_mouth]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#time_task_sync_week_appoint").click(function(){
	    if (this.checked) {
	...
	weekList.change(function() {
		var time_task_sync_week_appoint = $("#time_task_sync_week_appoint").prop("checked");
		if (time_task_sync_week_appoint) {
			var vals = [];
			...
			var item = $("input[name=time_task_sync_week]");
			item.val(val);
			item.change();
		}
	});
