...
function everyTime(dom) {
	var item = $("input[name=strategy_" + dom.name + "]");
	item.val("*");
	item.change();
}
...
function unAppoint(dom) {
	...
	if (name == "year")
		val = "";
	var item = $("input[name=strategy_" + name + "]");
	item.val(val);
	item.change();
}
...
$(function() {
	...
	var vals = $("input[name^='strategy_']");
	var cron = $("#strategyCron");
	...
	$("#strategy_sencond_appoint").click(function(){
	    if (this.checked) {
	...
	secondList.change(function() {
		var strategy_sencond_appoint = $("#strategy_sencond_appoint").prop("checked");
		if (strategy_sencond_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_second]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#strategy_min_appoint").click(function(){
	    if (this.checked) {
	...
	minList.change(function() {
		var strategy_min_appoint = $("#strategy_min_appoint").prop("checked");
		if (strategy_min_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_min]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#strategy_hour_appoint").click(function(){
	    if (this.checked) {
	...
	hourList.change(function() {
		var strategy_hour_appoint = $("#strategy_hour_appoint").prop("checked");
		if (strategy_hour_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_hour]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#strategy_day_appoint").click(function(){
	    if (this.checked) {
	...
	dayList.change(function() {
		var strategy_day_appoint = $("#strategy_day_appoint").prop("checked");
		if (strategy_day_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_day]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#strategy_mouth_appoint").click(function(){
	    if (this.checked) {
	...
	mouthList.change(function() {
		var strategy_mouth_appoint = $("#strategy_mouth_appoint").prop("checked");
		if (strategy_mouth_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_mouth]");
			item.val(val);
			item.change();
		}
	});
	...
	$("#strategy_week_appoint").click(function(){
	    if (this.checked) {
	...
	weekList.change(function() {
		var strategy_week_appoint = $("#strategy_week_appoint").prop("checked");
		if (strategy_week_appoint) {
			var vals = [];
			...
			var item = $("input[name=strategy_week]");
			item.val(val);
			item.change();
		}
	});
