...
<ul id="qstjfx_Tab" class="nav tabs"></ul>
<!-- 分项树模块start -->
<div id="qstjfx_div" class="leftarea information_left" >
<div id="qstjfx_con" class="information-model">
  ...
  <div class="search_qstjfx_style">
    ...
    <div class="search_qstjfx_div_style">
      <span class="zl_sxtj_span">日期范围:</span>
      <div id='qstjfx_group' style="display:inline-block"></div>
    </div>

    <div class="search_qstjfx_div_style">
      <span class="zl_sxtj_span">起始时间:</span>
      <input id="qstjfx_start_time" class="input-datecheck"
    ...
    <div class="search_qstjfx_div_style">
      ...
      <input id="qstjfx_end_time" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true})"/>
    </div>
    <div class="search_qstjfx_div_style">
      <span class="zl_sxtj_span">图标类型:</span>
      <div id="qstjfx_table_group"></div>
    </div>
    <div class="search_qstjfx_div_style">
      <span class="zl_sxtj_span">时间颗粒度:</span>
      <div id="qstjfx_time_group" style="display:inline-block"></div>
    </div>
    <div style="display: none" class="search_qstjfx_div_style">
      <span class="zl_sxtj_span">单位换算:</span>
      <div id="qstjfx_dw_group" style="display:inline-block"></div>
    </div>

    <div class="search_qstjfx_div_style"><span class="zl_sxtj_span">请选择分项>>> </span>
      ...
      <label style="cursor: pointer;right: 3vh;display: flex;position: absolute;">
        <input id="qstjfxCascade" type="checkbox" checked="checked" value="1">是否级联
      </label>
    </div>
  </div>
    ...
    <div id="qstjfx_bottom" style="height:5%!important;position: absolute;width:100%;bottom: 0;" >
        <div style="float: right;padding-top: 0.6vh;padding-right: 2vh;">
            <button type="button" style="width:5vw" id="search_button" class="btn btn-sm btn-primary no-margins toLeft" >
                <i class="fa fa-spinner"></i>&nbsp;加载数据
            </button>
            <button type="button" class="btn btn-sm btn-primary no-margins toLeft"
                    onclick="dataannlysis_fx_qstjfx.reset()">
...
<div class="information_right">
  <div  class="information_size" style="height:50%">
    ...
    <div id="qstjfx_chart" style="width: 95%; height: 90%;"></div>
  </div>
  ...
  <div class="information_size" style="height:50%">
    <div class="information-model" style="height:3.3vh">
        ...
        <#--打印按钮-->
      <a href="javascript:void(-1);" onclick="dataannlysis_fx_qstjfx.print()" class="btn btn-primary toLeft">
        <i class="fa fa-print" style="margin-top: 2.5px;margin-left: 2px;" aria-hidden="true"></i>&nbsp;打印
      </a>
    </div>
    <table id="qstjfxTable" class="table table-bordered" class="table table-bordered"
           style="white-space: nowrap;  overflow-x: scroll;">
      <thead>
      <tr id="qstjfxday" class="header_color">
      </tr>
      <tr id="qstjfxtime" class="header_color">
      </tr>
      </thead>
      <tbody id='qstjfx_body'>
      </tbody>
    </table>
  </div>
</div>
...
<script type="text/javascript">
  ;
  var dataannlysis_fx_qstjfx = (function ($, window, document, undefined) {
    ...
    $(function () {
      ...
      $("#search_button").click(function () {
        var dom = document.getElementById("qstjfx_chart");
        var myChart = echarts.init(dom, "light");
        myChart.clear();
        $('#qstjfxTable').fixedThead('destroy');//销毁
        //每次清数据重新获取数据
        $('#qstjfxday').html("");
        $('#qstjfxtime').html("");
        $('#qstjfx_body').html("");
      ...
      qstjfx_group_select('#qstjfx_group', qstjfx_group_id, qstjfx_group_val);
      ...
      qstjfx_dw_group_select('#qstjfx_dw_group', qstjfx_dw_group_id, qstjfx_dw_group_val);

      var qstjfx_time_group_id = ['0', '1', '2', '3'];
      var qstjfx_time_group_val = ['时', '日', '月', '年'];
      qstjfx_time_group_select('#qstjfx_time_group', qstjfx_time_group_id, qstjfx_time_group_val);


      //获取当前时间
      var date = getCurrentDate();
      //起始时间和默认时间
      $('#qstjfx_start_time').val(getFormatDate(date));
      $('#qstjfx_end_time').val(getFormatDate(date));
      $('#qstjfx_start_time').attr('disabled', 'disabled');
      $('#qstjfx_end_time').attr('disabled', 'disabled');

      $('#qstjfx_sametime_start_time').attr('disabled', 'disabled');
      $('#qstjfx_sametime_end_time').attr('disabled', 'disabled');
      getTabs();
    ...
    function getHeight() {
      //获取左侧高度
      var allheight = $("#qstjfx_div").height();//总高度
      var tbhbfx_con = $("#qstjfx_con").height();
      var num = $(".search_qstjfx_div_style").length;
      var bottom = $("#qstjfx_bottom").height();
      var tj = $(".search_qstjfx_div_style").outerHeight() - 1.2;
      var s = allheight - (num * tj) - bottom - tbhbfx_con;
      $("#tree_qstjfx").height(s);
    }
    ...
    function tblx_select(tb_idArray, tb_valArray) {
      $("#qstjfx_table_group").ISSPSpinnerBox({
        width: '9vw',//下拉列表宽度
        height: '2.9vh',//下拉列表高度
    ...
    //是否级联 点击事件
    $("#qstjfxCascade").click(function () {
      if ($('#qstjfxCascade').is(':checked')) {
        cascadeType = true;
        isFistSelect = false;
				deWhetherToManClick = true;
        //处理点击是否级联复选框时，先获取所有被选的复选框
        checkedGnbh = [];
        checkedGnbh = $('#tree_qstjfx').treeview('getChecked');
        // qstjfx_tree(cascadeType, isFistSelect, checkedGnbh);
      } else {
        cascadeType = false;
        isFistSelect = false;
...
//图表改变事件
    ...
    function timeChange(sp) {
      $("#qstjfx_start_time,#qstjfx_end_time").removeAttr("cursor").css("cursor", "not-allowed");
      var range = sp.id;
      $('#qstjfx_start_time').attr('disabled', 'disabled');
      $('#qstjfx_end_time').attr('disabled', 'disabled');
      switch (range) {
        case '0':
          ...
          $('#qstjfx_start_time').val(getFormatDate(today));
          $('#qstjfx_end_time').val(getFormatDate(today));
          break;
        case '1':
          var thisWeek = getCurrentWeek();
          $('#qstjfx_start_time').val(getFormatDate(thisWeek[0]));
          $('#qstjfx_end_time').val(getFormatDate(thisWeek[1]));
          break;

        case '2':
          var thismouth = getCurrentMonth();
          $('#qstjfx_start_time').val(getFormatDate(thismouth[0]));
          $('#qstjfx_end_time').val(getFormatDate(thismouth[1]));
          break;

        case '3':
          var thisSeason = getCurrentSeason();
          $('#qstjfx_start_time').val(getFormatDate(thisSeason[0]));
          $('#qstjfx_end_time').val(getFormatDate(thisSeason[1]));
          break;

        case '4':
          var thisYear = getCurrentYear();
          $('#qstjfx_start_time').val(getFormatDate(thisYear[0]));
          $('#qstjfx_end_time').val(getFormatDate(thisYear[1]));
          break;

        case '5':
          var lastDay = getPreviousDate();
          $('#qstjfx_start_time').val(getFormatDate(lastDay));
          $('#qstjfx_end_time').val(getFormatDate(lastDay));
          break;

        case '6':
          var lastWeek = getPreviousWeek();
          $('#qstjfx_start_time').val(getFormatDate(lastWeek[0]));
          $('#qstjfx_end_time').val(getFormatDate(lastWeek[1]));
          break;

        case '7':
          var lastMouth = getPreviousMonth();
          $('#qstjfx_start_time').val(getFormatDate(lastMouth[0]));
          $('#qstjfx_end_time').val(getFormatDate(lastMouth[1]));
          break;

        case '8':
          var lastSeason = getPreviousSeason();
          $('#qstjfx_start_time').val(getFormatDate(lastSeason[0]));
          $('#qstjfx_end_time').val(getFormatDate(lastSeason[1]));
          break;

        case '9':
          var lastYear = getPreviousYear();
          $('#qstjfx_start_time').val(getFormatDate(lastYear[0]));
          $('#qstjfx_end_time').val(getFormatDate(lastYear[1]));
          break;
        case '10':
          $("#qstjfx_start_time,#qstjfx_end_time").css("cursor", "default");
          $('#qstjfx_start_time').attr('disabled', false);
          $('#qstjfx_end_time').attr('disabled', false);
          break;
      }
    }
          ...
          if (result.hasOwnProperty("list")) {//判断result返回结果是否包含list
            if (result.list.length > 0) {//如果包含判断是否长度大于0
              ...
              for (var i = 0; i < result.list.length; i++) {
                ...
                if (i == 0) {
                  $("#qstjfx_Tab").append("<li class='active siblings' ><a  data-toggle='tab' href='#'  data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                } else {
                  $("#qstjfx_Tab").append("<li ><a  data-toggle='tab' href='#'   data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                }
    ...
    function getMonthTableData() {
      ...
      var dataarray = [];//数据
      var marray = [];//第几月
      var qstjfx_start_time = $('#qstjfx_start_time').val();//开始时间
      var qstjfx_end_time = $('#qstjfx_end_time').val();//结束时间
      var checkedGnbh = $('#tree_qstjfx').treeview('getChecked');
        ...
        success: function (result) {
          ...
          if (result.hasOwnProperty("list")) {
            if (result.list.length > 0) {
              ...
              $("#qstjfx_body").html(dataStr);
              setTimeout(fixRow, "100");
              chartShow(chartXdata, temp, series, x_unit, y_unit);
              $('#qstjfxday th').addClass('qstjfxFixHead');
              $('#qstjfxtime th').addClass('qstjfxFixHead');
        ...
        success: function (result) {
          ...
          if (result.hasOwnProperty("list")) {
            if (result.list.length > 0) {
              ...
              $("#qstjfx_body").html(dataStr);
              chartShow(chartXdata, temp, series, x_unit, y_unit);
              $("table thead").append("<tr id='qstjfxtime'></tr>");
              $('#qstjfxTable').fixedThead({side: '85%', body: '85%', thead: '93%', row: 1, col: 1});//固定表头和第一列
              $('#qstjfxday th').addClass('qstjfxFixHead');
              $('td').addClass('qstjfxFix');
              $('table tr td:first-child').addClass('qstjfxFixHead');
    ...
    function fixRow() {
      $('#qstjfxTable').fixedThead({side: '75%', body: '75%', thead: '93%', row: 2, col: 1});//固定表头和第
    }
          ...
          if (result.hasOwnProperty("list")) {//判断result返回结果是否包含list
            if (result.list.length > 0) {//如果包含判断是否长度大于0
              ...
              /*if (isFistSelect == true) {
                var firstNode = $("#tree_qstjfx").treeview('findNodes', [result.list[0].id, 'id']);
                var node = $("#tree_qstjfx").treeview('findNodes', [firstNode[0].id, 'id']);
                $('#tree_qstjfx').treeview('checkNode', [node, {silent: false}]);
                for (var i = 3; i < node.length; i++) {
                  var uncheckNode = $("#tree_qstjfx").treeview('findNodes', [node[i].id, 'id']);
                  $('#tree_qstjfx').treeview('uncheckNode', [uncheckNode, {silent: false}]);
                }
              }
              ...
              if (cascadeType == false) {
                ...
                for (var i = 0; i < checkedGnbh.length; i++) {
                  if (checkedGnbh[i].level != 1 && checkedGnbh[i].level != 2) {
                    var cNode = $('#tree_qstjfx').treeview('findNodes', [checkedGnbh[i].id, 'id']);
                    var parentNode = $('#tree_qstjfx').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                    chechedNodes.push(cNode);
                    $("#tree_qstjfx").treeview('uncheckNode', [parentNode, {silent: true}]);

                  }
                }
                for (var i = 0; i < chechedNodes.length; i++) {
                  $("#tree_qstjfx").treeview('checkNode', [chechedNodes[i], {silent: true}]);
                }
              ...
              if (cascadeType == true && isFistSelect == false) {
                for (var i = 0; i < checkedGnbh.length; i++) {
                  $("#tree_qstjfx").treeview('checkNode', [checkedGnbh[i], {silent: true}]);
                  parentNode = $('#tree_qstjfx').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                  var ppnode = $('#tree_qstjfx').treeview('findNodes', [parentNode[0].pid, 'id']);
                  $("#tree_qstjfx").treeview('checkNode', [parentNode, {silent: true}]);
                  $("#tree_qstjfx").treeview('checkNode', [ppnode[0], {silent: true}]);
                }
                ...
                var cancleChecks = $('#tree_qstjfx').treeview('getChecked');
                ...
                for (var i = 0; i < nodes.length; i++) {
                  $("#tree_qstjfx").treeview('uncheckNode', [nodes[i], {silent: true}]);
                }
    ...
    function nodeChecked(nodeData) {
      ...
      //获取设备树所有节点
      let allNodes = $("#tree_qstjfx").treeview('getNodes');

      if (cascadeType) {//级联
        //获取所有选中的节点
        checkNodes = $("#tree_qstjfx").treeview('getChecked');
        //获取父节点
    ...
    function unfatherNodes(fatherNodeId, allNodes) {
      ...
      $('#tree_qstjfx').treeview('uncheckNode', [fatherNodeId, {silent: true}]);
      //判断父节点是否含有父节点
      if (typeof fatherNodeId.pid != 'undefined') {//有的话,递归
        allNodes.forEach((node, i) => {
          if (node.nodeTreeId == fatherNodeId.pid) {
    ...
    function unchildNodesFunction(childNodes, allNodes) {
      ...
      childNodes.forEach((childNode, i) => {
        ...
        $('#tree_qstjfx').treeview('uncheckNode', [childNode, {silent: true}]);
        // checkNodes.push(childNode);
        if (Array.isArray(childNode.nodes)) {
    ...
    return {
      ...
      reset: function () {
        ...
        $('#qstjfx_start_time').attr('disabled', false);
        $('#qstjfx_end_time').attr('disabled', false);
        $("#qstjfx_start_time,#qstjfh_end_time").css("cursor", "default");
        $('#qstjfx_start_time').val("");
        $('#qstjfx_end_time').val("");
        var dom = document.getElementById("qstjfx_chart");
        var myChart = echarts.init(dom, "light");
        myChart.clear();
      ...
      //打印按钮
      print: function () {
        $("#clone_qstjfxTable_head").printThis({});
      }
    }
    ...
    //时间js----判断时间条件
    function timeFormat() {
      var startTime = $('#qstjfx_start_time').val();
      var endTime = $('#qstjfx_end_time').val();
