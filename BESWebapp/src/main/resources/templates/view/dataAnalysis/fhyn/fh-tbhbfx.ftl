...
<ul id="tbhbfh_Tab" class="nav tabs"></ul>
<!-- 分项树模块start -->
<div id="tbhbfh_div" class="leftarea information_left" id="leftsubitemconf">
  <div id="tbhbfh_con" class="information-model">
		<span class="tree_Subtitle">
			<i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;筛选条件(时间)>>>
		</span>
  </div>
  <div class="search_tbhbfh_style">

    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">对比形式:</span>
      <div id="tbhbfh_compare_group"></div>
    </div>

    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">日期范围:</span>
      <div id="tbhbfh_group"></div>
    </div>


    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">本期起始:</span>
      <input id="tbhbfh_start_time" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true,onpicked:dataannlysis_fh_tbhbfh.compareChange})">
    </div>


    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">本期终止:</span>
      <input id="tbhbfh_end_time" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true,onpicked:dataannlysis_fh_tbhbfh.compareChange})">
    </div>
    ...
    <div class="search_tbhbfh_div_style">
      ...
      <input id="tbhbfh_sametime_start_time" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',readOnly:true,onpicked:dataannlysis_fh_tbhbfh.compareChange})">
    </div>


    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">同期终止:</span>
      <input id="tbhbfh_sametime_end_time" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true})">
    </div>

    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">图表类型:</span>
      <div id="tbhbfh_table_group"></div>
    </div>
    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">时间颗粒度:</span>
      <div id="tbhbfh_time_group"></div>
    </div>

    <div class="search_tbhbfh_div_style">
      <span class="zl_sxtj_span">单位换算:</span>
      <div id="tbhbfh_dw_group"></div>
    </div>
    <div class="search_tbhbfh_div_style"><span class="zl_sxtj_span">请选择分户>>> </span>
      ...
      <label style="cursor: pointer;right: 3vh;display: flex;position: absolute;">
        <input id="tbhbfhCascade" type="checkbox" checked="checked" value="1">是否级联
      </label>
    </div>
  </div>
...
<div class="information_right">
  <div class="information_size" style="height:50%">
    ...
    <div id="tbhbfh_chart" style="width: 95%; height: 90%;"></div>
  </div>
  ...
  <div class="information_size" style="height:50%">
    <div class="information-model" style="height:3.3vh">
        ...
        <#--打印按钮-->
      <a href="javascript:void(-1);" onclick="dataannlysis_fh_tbhbfh.print()" class="btn btn-primary toLeft">
        <i class="fa fa-print" style="margin-top: 2.5px;margin-left: 2px;" aria-hidden="true"></i>&nbsp;打印
      </a>
    </div>
    <table id="tbhbfhTable" class="table table-bordered" style="white-space: nowrap;  overflow-x: scroll;">
      <thead>
      <tr id="tbhbfhday" class="header_color">
      </tr>
      </thead>
      <tbody id='tbhbfh_body'>
      </tbody>
    </table>
  </div>
</div>
...
<script type="text/javascript">
  ;
  var dataannlysis_fh_tbhbfh = (function ($, window, document, undefined) {
    ...
    $(function () {
      ...
      tbhbfh_group_select('#tbhbfh_group', tbhbfh_group_id, tbhbfh_group_val);
      ...
      tbhbfh_dw_group_select('#tbhbfh_dw_group', tbhbfh_dw_group_id, tbhbfh_dw_group_val);

      var tbhbfh_time_group_id = ['1', '0', '2', '3'];
      var tbhbfh_time_group_val = ['日', '时', '月', '年'];
      tbhbfh_time_group_select('#tbhbfh_time_group', tbhbfh_time_group_id, tbhbfh_time_group_val);

      var tbhbfh_compare_group_id = ['0', '1'];
      var tbhbfh_compare_group_val = ['同比', '环比'];
      tbhbfh_compare_group_select('#tbhbfh_compare_group', tbhbfh_compare_group_id, tbhbfh_compare_group_val);

      var tb_idArray = ['bar', 'line'];
      var tb_valArray = ['柱状图', '曲线图'];
      tblx_select(tb_idArray, tb_valArray);

      $('#tbhbfh_sametime_start_time').attr('disabled', 'disabled');
      $('#tbhbfh_sametime_end_time').attr('disabled', 'disabled');
      $("#tbhbfh_sametime_start_time,#tbhbfh_sametime_end_time").removeAttr("cursor").css("cursor", "not-allowed");
    ...
    var myChart = echarts.init(document.getElementById('tbhbfh_chart'));
...
// 		getHeight();
    ...
    //是否级联 点击事件
    $("#tbhbfhCascade").click(function () {
      if ($('#tbhbfhCascade').is(':checked')) {
        cascadeType = true;
        isFistSelect = false;
        deWhetherToManClick = true;
        //处理点击是否级联复选框时，先获取所有被选的复选框
        checkedGnbh = [];
        checkedGnbh = $('#tree_tbhbfh').treeview('getChecked');
        // qstjfx_tree(cascadeType, isFistSelect, checkedGnbh);
      } else {
        cascadeType = false;
        isFistSelect = false;
    ...
    function getHouseholdConfAndEnergyTypeData() {
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          // dataannlysis_fh_tbhbfh.getHourTableData();
        },
    ...
    function getHeight() {
      //获取左侧高度
      var allheight = $("#tbhbfh_div").height();//总高度
      var tbhbfx_con = $("#tbhbfh_con").height();
      var num = $(".search_tbhbfh_div_style").length;
      var bottom = $("#tbhbfh_bottom").height();
      var tj = $(".search_tbhbfh_div_style").outerHeight() - 1.2;
      var s = allheight - (num * tj) - bottom - tbhbfx_con;
      $("#tree_tbhbfh").height(s);
    }

    //图标初始化selected
    function tblx_select(tb_idArray, tb_valArray) {
      $("#tbhbfh_table_group").ISSPSpinnerBox({
        width: '9vw',//下拉列表宽度
        height: '2.9vh',//下拉列表高度
...
//图表改变事件
    ...
    function compareUnitChange(sp) {
      ...
      if (timeRange === "2") {//本月
        ...
        let bqstart = $("#tbhbfh_start_time").val();
        let bqend = $("#tbhbfh_end_time").val();
    ...
    function compareChange(start, end) {
      ...
      if (type == '0') {//同比
        ...
        $("#tbhbfh_sametime_start_time").val(getFormatDate(start));
        $("#tbhbfh_sametime_end_time").val(getFormatDate(end));
        ...
        var startCustom = $("#tbhbfh_sametime_start_time").val();
        if (start != null && end != null && startCustom != null) {
          var t = startCustom.getTime() + end.getTime() - start.getTime();
          $("#tbhbfh_sametime_start_time").val(t);
          $("#tbhbfh_sametime_end_time").val(getFormatDate(end));
        }
      }

      /*tbhbfh_start_time = $('#tbhbfh_start_time').val();//本期开始时间
      tbhbfh_end_time = $('#tbhbfh_end_time').val();//本期结束时间
      ...
      //自定义
      if (type == 2) {
        var startCustom = new Date($('#tbhbfh_sametime_start_time').val());
        var t = startCustom.getTime() + end.getTime()
            - start.getTime();
        end.setTime(t);
        $('#tbhbfh_sametime_end_time').val(getFormatDate(end));
        $('#tbhbfh_sametime_start_time').attr('disabled', false);
        $("#tbhbfh_sametime_start_time").css("cursor", "default");
      }*/
    ...
    function timeChange(sp) {
      $("#tbhbfh_start_time,#tbhbfh_end_time").removeAttr("cursor").css("cursor", "not-allowed");
      var range = sp.id;
      timeRange = sp.id;
      $('#tbhbfh_start_time').attr('disabled', 'disabled');
      $('#tbhbfh_end_time').attr('disabled', 'disabled');
      switch (range) {
        case '0':
          var today = getCurrentDate();
          $('#tbhbfh_start_time').val(getFormatDate(today));
          $('#tbhbfh_end_time').val(getFormatDate(today));
        ...
        case '1':
          ...
          // $('#tbhbfh_start_time').val(getFormatDate(thisWeek[0]));
          // $('#tbhbfh_end_time').val(getFormatDate(thisWeek[1]));
          var thisWeek = getCurrentWeek();
          $('#tbhbfh_start_time').val(getFormatDate(thisWeek[0]));
          $('#tbhbfh_end_time').val(getFormatDate(thisWeek[1]));
        ...
        case '2':
          ...
          $('#tbhbfh_start_time').val(getFormatDate(thismouth[0]));
          $('#tbhbfh_end_time').val(getFormatDate(thismouth[1]));
          compareChange(thismouth[0], thismouth[1]);
          break;

        case '3':
          var thisSeason = getCurrentSeason();
          $('#tbhbfh_start_time').val(getFormatDate(thisSeason[0]));
          $('#tbhbfh_end_time').val(getFormatDate(thisSeason[1]));
          compareChange(thisSeason[0], thisSeason[1]);
          break;

        case '4':
          var thisYear = getCurrentYear();
          $('#tbhbfh_start_time').val(getFormatDate(thisYear[0]));
          $('#tbhbfh_end_time').val(getFormatDate(thisYear[1]));
          compareChange(thisYear[0], thisYear[1]);
          break;

        case '5':
          // var lastDay = getPreviousDate();
          // $('#tbhbfh_start_time').val(getFormatDate(lastDay));
          // $('#tbhbfh_end_time').val(getFormatDate(lastDay));

          let todaystart =  getPreviousDate();
          let lastdaystart = getPreviousDate();
          $('#tbhbfh_start_time').val(getFormatDate(todaystart));
          $('#tbhbfh_end_time').val(getFormatDate(lastdaystart));
          //加载同期的起始时间和终止时间
        ...
        case '6':
          ...
          // $('#tbhbfh_start_time').val(getFormatDate(lastWeek[0]));
          // $('#tbhbfh_end_time').val(getFormatDate(lastWeek[1]));
          var lastWeek = getPreviousWeek();
          $('#tbhbfh_start_time').val(getFormatDate(lastWeek[0]));
          $('#tbhbfh_end_time').val(getFormatDate(lastWeek[1]));
        ...
        case '7':
          ...
          $('#tbhbfh_start_time').val(getFormatDate(lastMouth[0]));
          $('#tbhbfh_end_time').val(getFormatDate(lastMouth[1]));
          compareChange(lastMouth[0], lastMouth[1]);
          break;

        case '8':
          var lastSeason = getPreviousSeason();
          $('#tbhbfh_start_time').val(getFormatDate(lastSeason[0]));
          $('#tbhbfh_end_time').val(getFormatDate(lastSeason[1]));
          compareChange(lastSeason[0], lastSeason[1]);
          break;

        case '9':
          var lastYear = getPreviousYear();
          $('#tbhbfh_start_time').val(getFormatDate(lastYear[0]));
          $('#tbhbfh_end_time').val(getFormatDate(lastYear[1]));
          compareChange(lastYear[0], lastYear[1]);
          break;
        case '10':
          $("#tbhbfh_start_time,#tbhbfh_end_time").css("cursor", "default");
          $('#tbhbfh_start_time').attr('disabled', false);
          $('#tbhbfh_end_time').attr('disabled', false);
          break;
      }
      // compareChange();
          ...
          if (result.hasOwnProperty("list")) {//判断result返回结果是否包含list
            if (result.list.length > 0) {//如果包含判断是否长度大于0
              ...
              for (var i = 0; i < result.list.length; i++) {
                ...
                if (i == 0) {
                  $("#tbhbfh_Tab").append("<li class='active nocancel' ><a  data-toggle='tab' href='#'  data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                } else {
                  $("#tbhbfh_Tab").append("<li ><a  data-toggle='tab' href='#'   data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                }

              }
            }
            //点击tab,支路树变化
            $("#tbhbfh_Tab a").click(function () {
              $(this.parentNode).addClass("nocancel").siblings("li").removeClass("nocancel");
              $('#tree_tbhbfh').treeview('uncheckAll', {silent: true});
              _fnybh = $(this).attr("data");
              qstjfx_tree(cascadeType, false, checkedGnbh);

              var dom = document.getElementById("tbhbfh_chart");
              var myChart = echarts.init(dom, "light");
              myChart.clear();
              $('#tbhbfhTable').fixedThead('destroy');//销毁
              $('#tbhbfhday').html("");
              $('#tbhbfh_body').html("");
            });
          }
          qstjfx_tree(true, true, true);
...
/*
              if (isFistSelect == true) {
                var firstNode = $("#tree_tbhbfh").treeview('findNodes', [result.list[0].id, 'id']);
                var node = $("#tree_tbhbfh").treeview('findNodes', [firstNode[0].id, 'id']);
                $('#tree_tbhbfh').treeview('checkNode', [node, {silent: false}]);
                for (var i = 2; i < node.length; i++) {
                  var uncheckNode = $("#tree_tbhbfh").treeview('findNodes', [node[i].id, 'id']);
                  $('#tree_tbhbfh').treeview('uncheckNode', [uncheckNode, {silent: false}]);
                }
              }
              //点击不级联时，父级取消勾选
              if (cascadeType == false) {
                ...
                for (var i = 0; i < checkedGnbh.length; i++) {
                  if (checkedGnbh[i].pid != "" && checkedGnbh[i].pid != null && checkedGnbh[i].pid != 'undefined') {
                    var cNode = $('#tree_tbhbfh').treeview('findNodes', [checkedGnbh[i].id, 'id']);
                    var parentNode = $('#tree_tbhbfh').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                    chechedNodes.push(cNode);
                    $("#tree_tbhbfh").treeview('uncheckNode', [parentNode, {silent: true}]);

                  }
                }
                for (var i = 0; i < chechedNodes.length; i++) {
                  $("#tree_tbhbfh").treeview('checkNode', [chechedNodes[i], {silent: true}]);
                }
              ...
              if (cascadeType == true && isFistSelect == false) {
                for (var i = 0; i < checkedGnbh.length; i++) {
                  if (checkedGnbh[i].pid != "" && checkedGnbh[i].pid != null && checkedGnbh[i].pid != 'undefined') {
                    $("#tree_tbhbfh").treeview('checkNode', [checkedGnbh[i], {silent: true}]);
                    var parentNode = $('#tree_tbhbfh').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                    $("#tree_tbhbfh").treeview('checkNode', [parentNode, {silent: true}]);
                  }
                }
                var nodes = [];
                //去除联动勾选的数据
                $('#tree_tbhbfh').treeview('checkAll', {silent: true});
                var cancleChecks = $('#tree_tbhbfh').treeview('getChecked');
                ...
                for (var i = 0; i < nodes.length; i++) {
                  $("#tree_tbhbfh").treeview('uncheckNode', [nodes[i], {silent: true}]);
                }
    ...
    function nodeChecked(nodeData) {
      ...
      //获取设备树所有节点
      let allNodes = $("#tree_tbhbfh").treeview('getNodes');

      if (cascadeType) {//级联
        //获取所有选中的节点
        checkNodes = $("#tree_tbhbfh").treeview('getChecked');
        //获取父节点
    ...
    function unfatherNodes(fatherNodeId,allNodes) {
      ...
      $('#tree_tbhbfh').treeview('uncheckNode', [fatherNodeId, {silent: true}]);
      //判断父节点是否含有父节点
      if (typeof fatherNodeId.pid != 'undefined') {//有的话,递归
        allNodes.forEach((node,i) => {
          if (node.nodeTreeId == fatherNodeId.pid) {
    ...
    function unchildNodesFunction(childNodes,allNodes) {
      ...
      childNodes.forEach((childNode,i) => {
        ...
        $('#tree_tbhbfh').treeview('uncheckNode', [childNode, {silent: true}]);
        // checkNodes.push(childNode);
        if (Array.isArray(childNode.nodes)) {
...
//初始化时间
    function time_csh() {
      ...
      if (type == '0') {//同比
        ...
        $('#tbhbfh_start_time').val(getFormatDate(start));
        $('#tbhbfh_end_time').val(getFormatDate(time));
    ...
    return {
      ...
      compareChange: function () {
        var bqstart = $("#tbhbfh_start_time").val();
        var bqend = $("#tbhbfh_end_time").val();
        bqstart = parserDate(bqstart);
        bqend = parserDate(bqend);
        if (type == '0') {//同比
        ...
        $("#tbhbfh_sametime_start_time").val(getFormatDate(bqstart));
        $("#tbhbfh_sametime_end_time").val(getFormatDate(bqend));
      },
     ...
     /* compareChange: function () {
      ...
      getHourTableData: function () {
        ...
        $('#tbhbfhday').html("");
        $('#tbhbfh_body').html("");
        var qstjfx_start_time = $('#tbhbfh_start_time').val();//开始时间
        var qstjfx_end_time = $('#tbhbfh_end_time').val();//结束时间
        var checkedGnbh = $('#tree_tbhbfh').treeview('getChecked');
        var ftbhb_sametime_start = $('#tbhbfh_sametime_start_time').val();//同期开始时间
        var ftbhb_sametime_end = $('#tbhbfh_sametime_end_time').val();//同期结束时间
        //获取选中的树节点
        var checkedGnbh = $('#tree_tbhbfh').treeview('getChecked');
        var allTime = [];//存取所有时间
        ...
        $.ajax({
          ...
          success: function (result) {
            if (result.hasOwnProperty("map")
              ...
              var qstjfxdaydata = "<th class='tbhbfhFixHead' style='width:20%;white-space: nowrap'colspan='2' >分户用能名称</th>";
              for (var i = 0; i < time.length; i++) {
                //时
                if (qstjfx_time_group == '0') {
                  qstjfxdaydata += "<th class='tbhbfhFixHead' style='white-space: nowrap'>" +
              ...
              for (var i = 0; i < nodetreeIds.length; i++) {
                ...
                if (result.map[nodetreeIds[i]] != null && result.map[nodetreeIds[i]].length != 0) {
                  tdData += "<tr ><td rowspan='2' class='tbhbfhFixHead'  style='text-align:center;vertical-align:middle;white-space: nowrap' >" + result.map[nodetreeIds[i]][0].fFhmc + "</td><td class='tbhbfhFixHead'>本期</td>"
                  ...
                  for (var j = 0; j < allTime.length; j++) {
                    ...
                    if (flag == '1') {
                      ...
                      tdData += "<td class='tbhbfhFix' style='white-space: nowrap' >" + data + "</td>";
                      seriesData.push(data);
                    } else {
                      tdData += "<td class='tbhbfhFix' style='white-space: nowrap'>0.00</td>";
                  ...
                  tdData += "</tr> <tr><td class='tbhbfhFixHead' style='white-space: nowrap'>同期</td>"
                  ...
                  for (var j = 0; j < allTime.length; j++) {
                    ...
                    if (sameflag == '1') {
                      tdData += "<td class='tbhbfhFix' style='white-space: nowrap'>" + samedata + "</td>";
              ...
              $('#tbhbfh_body').html(tdData);
              $('#tbhbfhTable').fixedThead({side: '85%', body: '85%', thead: '93%', row: 1, col: 1});//固定表头和第一列
              //数据去重
              var echartData = [];
              var obj = {};
              ...
              var cols = [];
              var mytable = document.getElementById("tbhbfhTable");
          ...
          complete: function () {
			...
			exp: function () {
				...
				// jquery获取Excel表头数据
				let thead = $("#clone_tbhbfhTable_head>thead>tr>th").eq(0).text();
				let thead2 = $("#clone_tbhbfhTable_head>thead>tr").eq(0).find("th");
				alias.push(thead);
				names.push("a0");
          ...
          if (i != 0) {
            if (($(this).html()).indexOf("div") == -1 && ($(this).html()) != "" ) {
              ...
              names.push("a" + (i));
				...
				// 内容
				let tbodyTr = $("#clone_tbhbfhTable_head>tbody>tr");
      ...
      reset: function () {
        ...
        $('#tbhbfh_start_time').attr('disabled', false);
        $('#tbhbfh_end_time').attr('disabled', false);
        $("#tbhbfh_start_time,#qstjfh_end_time").css("cursor", "default");
        $('#tbhbfh_start_time').val("");
        $('#tbhbfh_end_time').val("");
        var dom = document.getElementById("tbhbfh_chart");
        var myChart = echarts.init(dom, "light");
        myChart.clear();
      ...
      print: function () {
        $("#clone_tbhbfhTable_head").printThis({});
      }
    }

    //时间js----判断时间条件
    function timeFormat() {
      var startTime = $('#tbhbfh_start_time').val();
      var endTime = $('#tbhbfh_end_time').val();
  ...
  dataannlysis_fh_tbhbfh.pageInit();
