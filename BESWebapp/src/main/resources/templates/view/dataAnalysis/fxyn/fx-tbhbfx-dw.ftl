...
<ul id="tbhbfx_Tab_dw" class="nav tabs tsys"></ul>
<!-- 分项树模块start -->
<div id="tbhbfx_div_dw" class="leftarea information_left" id="leftsubitemconf">
  <div id="tbhbfx_con_dw" class="information-model">
		<span class="tree_Subtitle">
			<i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;筛选条件>>>
		</span>
  </div>
  <div class="search_tbhbfx_style_dw">

    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">对比形式:</span>
      <div style="display: inline-block;" id="tbhbfx_compare_group_dw"></div>
    </div>

    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">日期范围:</span>
      <div style="display: inline-block;" id="tbhbfx_group_dw"></div>
    </div>


    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">本期起始:</span>
      <input id="tbhbfx_start_time_dw" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true,onpicked:dataannlysis_fx_tbhbfx_dw.compareChange})">
    </div>


    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">本期终止:</span>
      <input id="tbhbfx_end_time_dw" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true,onpicked:dataannlysis_fx_tbhbfx_dw.compareChange})">
    </div>
    ...
    <div class="search_tbhbfx_div_style_dw">
      ...
      <input id="tbhbfx_sametime_start_time_dw" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',readOnly:true,onpicked:dataannlysis_fx_tbhbfx_dw.compareChange})">
    </div>


    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">同期终止:</span>
      <input id="tbhbfx_sametime_end_time_dw" class="input-datecheck"
             onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',firstDayOfWeek:1,readOnly:true})">
    </div>
    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">图标类型:</span>
      <div id="tbhbfx_table_group_dw"></div>
    </div>
    <div class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">时间颗粒度:</span>
      <div style="display: inline-block;" id="tbhbfx_time_group_dw"></div>
    </div>


    <div style="display: none" class="search_tbhbfx_div_style_dw">
      <span class="zl_sxtj_span">单位换算:</span>
      <div style="display: inline-block;" id="tbhbfx_dw_group_dw"></div>

    </div>
    <div class="search_tbhbfx_div_style_dw"><span class="zl_sxtj_span">请选择分项>>> </span>
      ...
      <label style="cursor: pointer;right: 3vh;display: flex;position: absolute;">
        <input id="tbhbfxCascade_dw" type="checkbox" checked="checked" value="1">是否级联
      </label>
    </div>

  </div>

  <div id="tree_tbhbfx_dw"
       style="overflow-y: auto;overflow-x: auto;width: 100%;border-top:1px solid #007ABA;"></div>
  <div id="tbhbfx_bottom_dw"
...
<div class="information_right">
  <div class="information_size" style="height:50%">
    ...
    <div id="tbhbfx_chart_dw" style="width: 95%; height: 90%;"></div>
  </div>
  ...
  <div class="information_size " style="height:50%">
    ...
    <table id="tbhbfxTable_dw" class="table table-bordered"
           style="white-space: nowrap;  overflow-x: scroll; -webkit-overflow-scrolling: touch;">
      <thead>
      <tr id="tbhbfxday_dw" class="header_color">
      </tr>
      </thead>
      <tbody id='tbhbfx_body_dw'>
      </tbody>
    </table>
  </div>
</div>
...
<script type="text/javascript">
  ;
  var dataannlysis_fx_tbhbfx_dw = (function ($, window, document, undefined) {
    ...
    $(function () {
      ...
      tbhbfx_group_select('#tbhbfx_group_dw', tbhbfx_group_id, tbhbfx_group_val);
      ...
      tbhbfx_dw_group_select('#tbhbfx_dw_group_dw', tbhbfx_dw_group_id, tbhbfx_dw_group_val);
      ...
      tbhbfx_time_group_select('#tbhbfx_time_group_dw', tbhbfx_time_group_id, tbhbfx_time_group_val);

      var tbhbfx_compare_group_id = ['0', '1'];
      var tbhbfx_compare_group_val = ['同比', '环比'];
      tbhbfx_compare_group_select('#tbhbfx_compare_group_dw', tbhbfx_compare_group_id, tbhbfx_compare_group_val);

      $('#tbhbfx_sametime_start_time_dw').attr('disabled', 'disabled');
      $('#tbhbfx_sametime_end_time_dw').attr('disabled', 'disabled');
      $("#tbhbfx_sametime_start_time_dw,#tbhbfx_sametime_end_time_dw").removeAttr("cursor").css("cursor", "not-allowed");
    ...
    function getHeight() {
      //获取左侧高度
      var allheight = $("#tbhbfx_div_dw").height();//总高度
      var tbhbfx_con = $("#tbhbfx_con_dw").height();
      var num = $(".search_tbhbfx_div_style_dw").length;
      var bottom = $("#tbhbfx_bottom_dw").height();
      var tj = $(".search_tbhbfx_div_style_dw").outerHeight() - 1.2;
      var s = allheight - (num * tj) - bottom - tbhbfx_con;
      $("#tree_tbhbfx_dw").height(s);
    }
    ...
    function tblx_select(tb_idArray, tb_valArray) {
      $("#tbhbfx_table_group_dw").ISSPSpinnerBox({
        width: '9vw',//下拉列表宽度
        height: '2.9vh',//下拉列表高度
...
//图表改变事件
    ...
    function compareUnitChange(sp) {
      type = sp.id;
			if (timeRange === "2") {//本月
				...
				let bqstart = $("#tbhbfx_start_time_dw").val();
				let bqend = $("#tbhbfx_end_time_dw").val();
    ...
    function timeChange(sp) {
      $("#tbhbfx_start_time_dw,#tbhbfx_end_time_dw").removeAttr("cursor").css("cursor", "not-allowed");
      var range = sp.id;
      timeRange = sp.id;
      $('#tbhbfx_start_time_dw').attr('disabled', 'disabled');
      $('#tbhbfx_end_time_dw').attr('disabled', 'disabled');
      switch (range) {
        case '0':
          var today = getCurrentDate();
          $('#tbhbfx_start_time_dw').val(getFormatDate(today));
          $('#tbhbfx_end_time_dw').val(getFormatDate(today));
        ...
        case '1':
          ...
          // $('#tbhbfx_start_time_dw').val(getFormatDate(thisWeek[0]));
          // $('#tbhbfx_end_time_dw').val(getFormatDate(thisWeek[1]));
					var thisWeek = getCurrentWeek();
					$('#tbhbfx_start_time_dw').val(getFormatDate(thisWeek[0]));
					$('#tbhbfx_end_time_dw').val(getFormatDate(thisWeek[1]));
        ...
        case '2':
          ...
          $('#tbhbfx_start_time_dw').val(getFormatDate(thismouth[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(thismouth[1]));
					compareChange(thismouth[0], thismouth[1]);
          break;

        case '3':
          var thisSeason = getCurrentSeason();
          $('#tbhbfx_start_time_dw').val(getFormatDate(thisSeason[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(thisSeason[1]));
					compareChange(thisSeason[0], thisSeason[1]);
          break;

        case '4':
          var thisYear = getCurrentYear();
          $('#tbhbfx_start_time_dw').val(getFormatDate(thisYear[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(thisYear[1]));
					compareChange(thisYear[0], thisYear[1]);
          break;

        case '5':
          // var lastDay = getPreviousDate();
          // $('#tbhbfx_start_time_dw').val(getFormatDate(lastDay));
          // $('#tbhbfx_end_time_dw').val(getFormatDate(lastDay));
					let todaystart =  getPreviousDate();
					let lastdaystart = getPreviousDate();
					$('#tbhbfx_start_time_dw').val(getFormatDate(todaystart));
					$('#tbhbfx_end_time_dw').val(getFormatDate(lastdaystart));
					compareChange(todaystart, lastdaystart);
          break;

        case '6':
          // var lastWeek = getPreviousWeek();
          // $('#tbhbfx_start_time_dw').val(getFormatDate(lastWeek[0]));
          // $('#tbhbfx_end_time_dw').val(getFormatDate(lastWeek[1]));
					var lastWeek = getPreviousWeek();
					$('#tbhbfx_start_time_dw').val(getFormatDate(lastWeek[0]));
					$('#tbhbfx_end_time_dw').val(getFormatDate(lastWeek[1]));
        ...
        case '7':
          ...
          $('#tbhbfx_start_time_dw').val(getFormatDate(lastMouth[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(lastMouth[1]));
					compareChange(lastMouth[0], lastMouth[1]);
          break;

        case '8':
          var lastSeason = getPreviousSeason();
          $('#tbhbfx_start_time_dw').val(getFormatDate(lastSeason[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(lastSeason[1]));
					compareChange(lastSeason[0], lastSeason[1]);
          break;

        case '9':
          var lastYear = getPreviousYear();
          $('#tbhbfx_start_time_dw').val(getFormatDate(lastYear[0]));
          $('#tbhbfx_end_time_dw').val(getFormatDate(lastYear[1]));
					compareChange(lastYear[0], lastYear[1]);
          break;
        case '10':
          $("#tbhbfx_start_time_dw,#tbhbfx_end_time_dw").css("cursor", "default");
          $('#tbhbfx_start_time_dw').attr('disabled', false);
          $('#tbhbfx_end_time_dw').attr('disabled', false);
          break;
      }
      // compareChange();
    ...
    function compareChange(start, end) {
			...
			if (type == '0') {//同比
				...
				$("#tbhbfx_sametime_start_time_dw").val(getFormatDate(start));
				$("#tbhbfx_sametime_end_time_dw").val(getFormatDate(end));
				...
				var startCustom = $("#tbhbfx_sametime_start_time_dw").val();
				if (start != null && end != null && startCustom != null) {
					var t = startCustom.getTime() + end.getTime() - start.getTime();
					$("#tbhbfx_sametime_end_time_dw").val(t);
					$("#tbhbfx_sametime_end_time_dw").val(getFormatDate(end));
				}
			}

      /*tbhbfx_start_time = $('#tbhbfx_start_time_dw').val();//本期开始时间
      tbhbfx_end_time = $('#tbhbfx_end_time_dw').val();//本期结束时间
      ...
      //自定义
      if (type == 2) {
        var startCustom = new Date($('#tbhbfx_sametime_start_time_dw').val());
        var t = startCustom.getTime() + end.getTime()
            - start.getTime();
        end.setTime(t);
        $('#tbhbfx_sametime_end_time_dw').val(getFormatDate(end));
        $('#tbhbfx_sametime_start_time_dw').attr('disabled', false);
        $("#tbhbfx_sametime_start_time_dw").css("cursor", "default");
      }*/
          ...
          if (result.hasOwnProperty("list")) {//判断result返回结果是否包含list
            if (result.list.length > 0) {//如果包含判断是否长度大于0
              ...
              for (var i = 0; i < result.list.length; i++) {
                ...
                if (i == 0) {
                  $("#tbhbfx_Tab_dw").append("<li class='active nocancel' ><a  data-toggle='tab' href='#'  data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                } else {
                  $("#tbhbfx_Tab_dw").append("<li ><a  data-toggle='tab' href='#'   data='" + treeNode.fnybh + "'>" + treeNode.fnymc + "</a></li>");
                }
              }
							qstjfx_tree(cascadeType, false, checkedGnbh);
            }
            //点击tab,支路树变化
            $("#tbhbfx_Tab_dw a").click(function () {
              $(this.parentNode).addClass("nocancel").siblings("li").removeClass("nocancel");
              _fnybh = $(this).attr("data");
              $('#tree_tbhbfx_dw').treeview('uncheckAll', {silent: true});
              qstjfx_tree(cascadeType, false, checkedGnbh);
              var dom = document.getElementById("tbhbfx_chart_dw");
              var myChart = echarts.init(dom, "light");
              myChart.clear();
              $('#tbhbfxTable_dw').fixedThead('destroy');//销毁
              $('#tbhbfxday_dw').html("");
              $('#tbhbfx_body_dw').html("");
            });
          }
    ...
    //是否级联 点击事件
    $("#tbhbfxCascade_dw").click(function () {
      if ($('#tbhbfxCascade_dw').is(':checked')) {
        cascadeType = true;
        isFistSelect = false;
				deWhetherToManClick = true;
        //处理点击是否级联复选框时，先获取所有被选的复选框
        checkedGnbh = [];
        checkedGnbh = $('#tree_tbhbfx_dw').treeview('getChecked');
        // qstjfx_tree(cascadeType, isFistSelect, checkedGnbh);
      } else {
        cascadeType = false;
        isFistSelect = false;
    ...
    function qstjfx_tree(cascadeType, isFistSelect, checkedGnbh) {
      $.ajax({
          ...
          if (result.hasOwnProperty("list")) {//判断result返回结果是否包含list
            if (result.list.length > 0) {//如果包含判断是否长度大于0
             ...
             /* if (isFistSelect == true) {
                var firstNode = $("#tree_tbhbfx_dw").treeview('findNodes', [result.list[0].id, 'id']);
                var node = $("#tree_tbhbfx_dw").treeview('findNodes', [firstNode[0].id, 'id']);
                $('#tree_tbhbfx_dw').treeview('checkNode', [node, {silent: false}]);
                for (var i = 3; i < node.length; i++) {
                  var uncheckNode = $("#tree_tbhbfx_dw").treeview('findNodes', [node[i].id, 'id']);
                  $('#tree_tbhbfx_dw').treeview('uncheckNode', [uncheckNode, {silent: false}]);
                }
              }
              //点击不级联时，父级取消勾选
              if (cascadeType == false) {
                ...
                for (var i = 0; i < checkedGnbh.length; i++) {
                  if (checkedGnbh[i].level != 1 && checkedGnbh[i].level != 2) {
                    var cNode = $('#tree_tbhbfx_dw').treeview('findNodes', [checkedGnbh[i].id, 'id']);
                    var parentNode = $('#tree_tbhbfx_dw').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                    chechedNodes.push(cNode);
                    $("#tree_tbhbfx_dw").treeview('uncheckNode', [parentNode, {silent: true}]);

                  }
                }
                for (var i = 0; i < chechedNodes.length; i++) {
                  $("#tree_tbhbfx_dw").treeview('checkNode', [chechedNodes[i], {silent: true}]);
                }
              ...
              if (cascadeType == true && isFistSelect == false) {
                for (var i = 0; i < checkedGnbh.length; i++) {
                  $("#tree_tbhbfx_dw").treeview('checkNode', [checkedGnbh[i], {silent: true}]);
                  var parentNode = $('#tree_tbhbfx_dw').treeview('findNodes', [checkedGnbh[i].pid, 'id']);
                  $("#tree_tbhbfx_dw").treeview('checkNode', [parentNode, {silent: true}]);
                  var ppnode = $('#tree_tbhbfx_dw').treeview('findNodes', [parentNode[0].pid, 'id']);
                  $("#tree_tbhbfx_dw").treeview('checkNode', [ppnode[0], {silent: true}]);
                }

                var nodes = [];
                //去除联动勾选的数据

                var cancleChecks = $('#tree_tbhbfx_dw').treeview('getChecked');
                ...
                for (var i = 0; i < nodes.length; i++) {
                  $("#tree_tbhbfx_dw").treeview('uncheckNode', [nodes[i], {silent: true}]);
                }
		...
		function nodeChecked(nodeData) {
			...
			//获取设备树所有节点
			let allNodes = $("#tree_tbhbfx_dw").treeview('getNodes');

			if (cascadeType) {//级联
				//获取所有选中的节点
				checkNodes = $("#tree_tbhbfx_dw").treeview('getChecked');
				//获取父节点
		...
		function unfatherNodes(fatherNodeId,allNodes) {
			...
			$('#tree_tbhbfx_dw').treeview('uncheckNode', [fatherNodeId, {silent: true}]);
			//判断父节点是否含有父节点
			if (typeof fatherNodeId.pid != 'undefined') {//有的话,递归
				allNodes.forEach((node,i) => {
					if (node.nodeTreeId == fatherNodeId.pid) {
		...
		function unchildNodesFunction(childNodes,allNodes) {
			...
			childNodes.forEach((childNode,i) => {
				...
				$('#tree_tbhbfx_dw').treeview('uncheckNode', [childNode, {silent: true}]);
				// checkNodes.push(childNode);
				if (Array.isArray(childNode.nodes)) {
		...
		function time_csh() {
			...
			if (type == '0') {//同比
				...
				$('#tbhbfx_start_time_dw').val(getFormatDate(start));
				$('#tbhbfx_end_time_dw').val(getFormatDate(time));
    ...
    return {
      ...
      compareChange: function () {
				...
				$("#tbhbfx_sametime_start_time_dw").val(getFormatDate(bqstart));
				$("#tbhbfx_sametime_end_time_dw").val(getFormatDate(bqend));
      ...
      getHourTableData: function () {
        ...
        $('#tbhbfxday_dw').html("");
        $('#tbhbfx_body_dw').html("");
        var qstjfx_start_time = $('#tbhbfx_start_time_dw').val();//开始时间
        var qstjfx_end_time = $('#tbhbfx_end_time_dw').val();//结束时间
        var checkedGnbh = $('#tree_tbhbfx_dw').treeview('getChecked');
        var ftbhb_sametime_start = $('#tbhbfx_sametime_start_time_dw').val();//同期开始时间
        var ftbhb_sametime_end = $('#tbhbfx_sametime_end_time_dw').val();//同期结束时间
        //获取选中的树节点
        var checkedGnbh = $('#tree_tbhbfx_dw').treeview('getChecked');
        var allTime = [];//存取所有时间
        ...
        $.ajax({
          ...
          success: function (result) {
            if (result.hasOwnProperty("map")
              ...
              $('#tbhbfxday_dw').html(qstjfxdaydata);
              var tdData = "";
              var seriesData = [];
              ...
              $('#tbhbfx_body_dw').html(tdData);
              $('#tbhbfxTable_dw').fixedThead({side: '85%', body: '85%', thead: '93%', row: 1, col: 1});//固定表头和第
              ...
              var cols = [];
              var mytable = document.getElementById("tbhbfxTable_dw");
              ...
              nodeNames = [];
              for (var i = 0; i < fxNames.length; i++) {
                nodeNames.push(fxNames[i].fFxmc);
              }
      ...
      reset: function () {
        ...
        $("#tbhbfx_group_dw").ISSPSpinnerBox({
          width: '9vw',//下拉列表宽度
          height: '2.9vh',//下拉列表高度
          margLeft: '0px',//margin-left属性
          isHasData: true,
        ...
        $('#tbhbfx_start_time_dw').attr('disabled', false);
        $('#tbhbfx_end_time_dw').attr('disabled', false);
        $("#tbhbfx_start_time_dw,#qtbhbfx_end_time_dw").css("cursor", "default");
        $('#tbhbfx_start_time_dw').val("");
        $('#tbhbfx_end_time_dw').val("");
        var dom = document.getElementById("tbhbfx_chart_dw");
        var myChart = echarts.init(dom, "light");
        myChart.clear();
        $('#tbhbfxTable_dw').fixedThead('destroy');//销毁
      ...
      pageInit: function () {
				time_csh();//初始化时间
        // dataannlysis_fx_tbhbfx_dw.compareChange();
        // dataannlysis_fx_tbhbfx_dw.getHourTableData();
    ...
    //时间js----判断时间条件
    function timeFormat() {
      var startTime = $('#tbhbfx_start_time_dw').val();
      var endTime = $('#tbhbfx_end_time_dw').val();
  ...
  dataannlysis_fx_tbhbfx_dw.pageInit();
