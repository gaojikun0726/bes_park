    ...
    <div class="input-group" style="height:30px;width:100%;">
        <div style="width: 50%;float: left;position: relative;padding-right: 15px;">
            <a id="addbranch" href="javascript:void(-1);"
               onclick="basedatamanage_efficiencyanalysis_branchConf.show_addbranch();" class="btn btn-primary">
...
<div class="leftarea" id="leftbranchconf" style="margin-top:-9px;height:93%">
    <button id="btn_zzjg_branch" type="button" class="btn btn-primary" data-toggle="modal"
            data-target='#modal-branch-zzjgtree' style="width:100%;height:5%">
            ...
            <div class="modal-body">
                <form role="form" id="addbranchform" name="addbranchform" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="fZlmc" name="fZlmc" placeholder="请输入支路名称" required
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="fZzjgbh_branch" name="fZzjgbh_branch" class="form-control"
                                   readonly="readonly">
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit_BranchForm" name="edit_BranchForm" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="edit_f_zbh">支路编号 <span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" id="edit_fZlbh" name="edit_fZlbh" required class="form-control"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="edit_f_zmc">支路名称<span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="edit_f_Location">所属位置<span
                                    class="text-danger"></span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="edit_fRatedPower">额定功率<span
                                    class="text-danger"></span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="edit_fZzjgbh_branch">组织机构编号<span
                                    class="text-danger"></span></label>
                        <div class="col-sm-8">
                            <input type="text" id="edit_fZzjgbh_branch" name="edit_fZzjgbh_branch" class="form-control"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group m-t-sm">
                    ...
                    <div style="padding:2px 2px 2px 10px;height:6%;">
                        <div style="float:left;">
                            <input type="text" class="input-sm form-control"
                                   style="width: calc(100%);padding: 4px 30px;" id="notincludeAmtKeywords"
                                   name="notincludeAmtKeywords" value="" placeholder="电表编号、名称">
                        </div>
                        <div style="float:left;">
		     <span class="input-group-btn" style="width: 60px;">
				<button class="btn btn-primary btn-sm m-b-none" id="queryNotIncludeAmt"
                        onclick="basedatamanage_efficiencyanalysis_branchConf.searchNotIncludeAmt()">
                ...
                <div style="width:100px;height:400px;float:left">
                    <div id="AmtrightMove" style="margin-top:200px;margin-left:23px;">
                        <button id="branchConf_right" type="button"
                                onclick="basedatamanage_efficiencyanalysis_branchConf.AmtrightMove()"
                                class="btn btn-primary">>>
                        </button>
                    </div>
                    <div id="AmtleftMove" style="margin-top:20px;margin-left:23px;">
                        <button id="branchConf_left" type="button"
                                onclick="basedatamanage_efficiencyanalysis_branchConf.AmtleftMove()"
                                class="btn btn-primary"><<
                        </button>
                    </div>
                </div>
                ...
                <div class="includeCss">
                    ...
                    <div style="position: relative;padding:2px 2px 2px 10px;height:6%;">
                        <div style="float:left;">
                            <input type="text" class="input-sm form-control"
                                   style="width: calc(100%);padding: 4px 30px;" id="includeAmtKeywords"
                                   name="includeAmtKeywords" value="" placeholder="电表编号、名称">
                        </div>
                        <div style="float:left;">
		     <span class="input-group-btn" style="width: 60px;">
				<button class="btn btn-primary btn-sm m-b-none" id="queryIncludeAmt"
                        onclick="basedatamanage_efficiencyanalysis_branchConf.searchIncludeAmt()">
                	<i class="fa fa-search"></i> 搜索
                </button>
            </span>
                        </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == '1') {
                        ...
                        //在已选择表格中添加该条数据
                        $('#branchAmt_include').tabulator("addRow", {
                            fSysName: data.data.fSysName,
