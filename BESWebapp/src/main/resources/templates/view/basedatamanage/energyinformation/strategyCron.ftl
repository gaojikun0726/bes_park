...
<script src="${ctx}/static/js/cron/strategyCron.js" type="text/javascript"></script>
<style type="text/css">
  .line
  {
    position: initial;
    ...
    <div class="easyui-tabs" data-options="fit:true,border:false">
      <div title="秒">
        ...
        <div class="line">
          ...
          秒执行一次</div>
        <div class="line">
          <input type="radio" name="second" id="strategy_sencond_appoint">
          指定</div>
      ...
      <div title="分钟">
        ...
        <div class="line">
          ...
          分钟执行一次</div>
        <div class="line">
          <input type="radio" name="min" id="strategy_min_appoint">
          指定</div>
      ...
      <div title="小时">
        ...
        <div class="line">
          ...
          小时执行一次</div>
        <div class="line">
          <input type="radio" name="hour" id="strategy_hour_appoint">
          指定</div>
      ...
      <div title="日">
        ...
        <div class="line">
          ...
          本月最后一天</div>
        <div class="line">
          <input type="radio" name="day" id="strategy_day_appoint">
          指定</div>
      ...
      <div title="月">
        ...
        <div class="line">
          ...
          月执行一次</div>
        <div class="line">
          <input type="radio" name="mouth" id="strategy_mouth_appoint">
          指定</div>
      ...
      <div title="周">
        ...
        <div class="line">
          ...
          本月最后一个星期<input class="numberspinner" style="width: 60px;" data-options="min:1,max:7"
                         id="weekStart2" value="1"></div>
        <div class="line">
          <input type="radio" name="week" id="strategy_week_appoint">
          指定</div>
    ...
    <fieldset style="border-radius: 3px; height: 220px;">
      ...
      <table style="height: 100px;">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="strategy_second" class="col form-control" value="*" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_min" class="col form-control" value="*" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_hour" class="col form-control" value="*" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_day" class="col form-control" value="*" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_mouth" class="col form-control" value="*" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_week" class="col form-control" value="?" readonly="readonly" />
          </td>
          <td>
            <input type="text" name="strategy_year" class="col form-control" readonly="readonly" />
          </td>
        </tr>
        <tr>
          <td>Cron 表达式:</td>
          <td colspan="6"><input  class="form-control" type="text" name="strategyCron" style="width: 100%;" id="strategyCron"
            /></td>
          <td>
            <button class="btn btn-md btn-primary" style="width: 5vw" type="button" onclick="strategy_cron_page.btnFan()">反解析到UI</button>
      ...
      <button class="btn btn-md btn-primary" type="button" style="margin-left: 300px;margin-top: 30px;width: 200px;height: 40px;"
              data-dismiss="modal"
              onclick="strategy_cron_page.checkCron()"><strong>选中当前表达式</strong></button>
...
<script type="text/javascript">
  ;
  var strategy_cron_page = (function($, window, document,undefined) {

    $(function () {
      let cronValue = $('#strategyCronEdit').val();
      $("#strategyCron").val(cronValue);
    })
    //选中当前表达式
    function checkCron() {

      let cron = document.getElementById("strategyCron").value;
      basedatamanage_eqmanage_strategy.cron(cron);
    }
    /*killIe*/
    $.parser.parse($("body"));
    ...
    function btnFan() {
      ...
      //获取参数中表达式的值
      var txt = $("#strategyCron").val();
      if (txt) {
        var regs = txt.split(' ');
        $("input[name=strategy_second]").val(regs[0]);
        $("input[name=strategy_min]").val(regs[1]);
        $("input[name=strategy_hour]").val(regs[2]);
        $("input[name=strategy_day]").val(regs[3]);
        $("input[name=strategy_mouth]").val(regs[4]);
        $("input[name=strategy_week]").val(regs[5]);
        ...
        if (regs.length > 6) {
          $("input[name=strategy_year]").val(regs[6]);
          initYear(regs[6]);
        }
      }
    }
