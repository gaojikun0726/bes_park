...
-->
<div style="height:95%">
    <div id="WarnRecord_iboxTable"></div>
</div>
<#---分页表单----->
<div style="height:30px">
    <form action="${ctx}/zhdg/warnrecord/getSearch" id="WarnRecordModulePageForm">
        ...
        <#assign showPageId = "WarnRecord_ibox"><!-- showPageId: ajax异步分页获取的数据需要加载到指定的位置 -->
        <#include "/common/page.ftl"/>
    </form>
</div>

 <script type="text/javascript">
;var zhdg_WarnRecord_listModuleClosurePage = (function($, window, document, undefined){

    //创建并设置table属性
    $("#WarnRecord_iboxTable").tabulator({
            height:"100%",
            ...
            columns:[
                ...
                {title:"设备id",field:"pointid",sorter:"string",editor:false,align:"center",headerSort:false},
    ...
    $("#WarnRecord_iboxTable").tabulator("setData",'${pageList}');
    return {
        get_curRow : function(){
            return _curRow;
        }
