        ...
        <div class="pfjk_top_left">
            <div class="pfjk_top_left_all">
                <ul>
                    ...
                    <li>
                        <select id="PFSI1F_DDC2_M100" onchange="dataAnalysis_pfjk.setLampPoint(this)">
            ...
            <div class="pfjk_top_right_all">
                <ul>
                   <li>
                    ...
                    <li>
                        <span id="PFSI1F_DDC2_M1012"></span>
                    </li> 
                    <li>
                        <span>机组故障状态1</span>
                    </li>
                    <li>
                        <span id="PFSI1F_DDC2_M1013"></span>
                    </li>
                    <li>
                        <span>机组就地远程状态1</span>
                    </li>
                    <li>
                        <span id="PFSI1F_DDC2_M1011"></span>
                    </li>
                </ul>
            </div>
        </div>
