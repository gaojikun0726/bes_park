        ...
        <div class="pfjk_top_left">
            <div class="pfjk_top_left_all">
                <ul>
                    ...
                    <li>
                        <select id="PFSA1F_DDC5_M100" onchange="dataAnalysis_pfjk.setLampPoint(this)"> 
        ...
        <div class="pfjk_top_right">
            <div class="pfjk_top_right_all">
                <ul>
                    ...
                    <li>
                        <span id="PFSA1F_DDC5_M1010"></span>
                    </li>
                    <li>
                        <span>机组故障状态1</span>
                    </li>
                    <li>
                        <span id="PFSA1F_DDC5_M109"></span>
                    </li>
                    <li>
                        <span>机组就地远程状态1</span>
                    </li>
                    <li>
                        <span id="PFSA1F_DDC5_M108"></span>
                    </li>
                </ul>
            </div>
        </div>
