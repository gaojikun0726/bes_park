        ...
        <div class="ktjk_top_left">
            <div class="ktjk_top_right_all">
                <ul>
                    ...
                    <li style="width: 20%;">
                        <select id="KT_AirUnitRunStopCmd_1_A8_1" onchange="dataAnalysis_ktjk2.setLampVPoint(this)">
                ...
                <ul>
                    ...
                    <li style="width: 20%;">
                        <select id="KT_SetWorkMode_1_A8_1" onchange="dataAnalysis_ktjk2.setLampVPoint(this)">
        ...
        <div class="ktjk_top_right">
            <div class="ktjk_top_right_all">
                <ul>
                    ...
                    <li>
                        <span id="KT_RunStopStatus_1_A8_1"></span>
                    </li>
                    <li>
                        <span>A8就地远程状态</span>
                    </li>
                    <li>
                        <span id="KT_ManualAutoStatus_1_A8_1"></span>
                    </li>
					<li>
                        <span>A8综合故障报警</span>
                    </li>
                    <li>
                        <span id="KT_AlarmStatus_1_A8_1"></span>
                    </li>
                </ul>

                 <ul>
                	<li>
                        <span>A8机组工作模式反馈</span>
                    </li>
                    <li>
                        <span id="KT_WorkMode_1_A8_1"></span>
                    </li>
