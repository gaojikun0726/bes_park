            ...
            <div class="ktjk_top_left_all">
                <ul>
                    ...
                    <li style="width: 20%;">
                        ...
                        <button  type="button" class="btn btn-primary" ids="KT_YWA2_DDC1_M108" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                    ...
                    <li style="width: 20%;">
                        ...
                        <span class="input-group-btn" style="display: inline-block;">
                        <button  type="button" class="btn btn-primary" ids="KT_YWA2_DDC1_M208" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         ...
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC1_M209" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                    ...
                    <li style="width: 20%;">
                        ...
                        <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC1_M2010" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                </ul>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         ...
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M104" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                    ...
                    <li style="width: 20%;">
                        ...
                        <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M105" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                </ul>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         ...
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M106" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                    ...
                    <li style="width: 20%;">
                        ...
                        <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M107" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                </ul>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         ...
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M204" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                    ...
                    <li style="width: 20%;">
                        ...
                        <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M205" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                </ul>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         ...
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="KT_YWA2_DDC2_M206" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                </ul>
                 ...
                 <ul>
                     ...
                     <li style="width: 20%;">
                         <input type="number" id="KT_" class="form-control number" style="width:40%;display: inline-block;" >
                         <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                     </li>
                    ...
                    <li style="width: 20%;">
                        <input type="number" id="KT_" class="form-control number" style="width:40%;display: inline-block;" >
                        <span class="input-group-btn" style="display: inline-block;">
                        <button type="button" class="btn btn-primary" ids="XFEB1_DDC1_M108" onclick="dataAnalysis_ktjk2.setWaterPoint(this)">设置</button></span>
                    </li>
                </ul>
