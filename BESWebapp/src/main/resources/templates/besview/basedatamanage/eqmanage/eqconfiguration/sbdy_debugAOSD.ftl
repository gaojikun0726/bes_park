		...
		<div style="margin-left: 233px; padding-right: 15px;">
			<span>
				<button id="synDataBtn" class="btn sbtreeNodeBtn"
					onclick="basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfoSD.debugDOInfo();">执行</button>
...
;
var basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfoSD = (function($,window, document, undefined) {
	var _ctx = '${ctx}';
