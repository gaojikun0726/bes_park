                ...
                <div class="frist_attr" >
                        ...
                        <div class="vertical-timeline-block eqTreeAttrLineWidth">
                            <div class="has-success">
                                ...
                                <div class="col-sm-4">
                                    <input id="f_sys_name" name="f_sys_name" value="${besSbPzStruct.f_nick_name}" type="text" class="form-control" readonly="readonly" onchange="basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfo_common.saveBtnIsEffective()">
                                </div>
                            </div>
                           <#-- <div class="has-success">
