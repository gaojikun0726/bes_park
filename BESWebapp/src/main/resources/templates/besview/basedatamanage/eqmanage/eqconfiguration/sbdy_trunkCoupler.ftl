                        ...
                        <div class="vertical-timeline-block eqTreeAttrLineWidth"  >
                            <div class="has-success">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="f_sys_name" name="f_sys_name" value="${returnObject.data.F_SYS_NAME_OLD}" type="text" class="form-control" readonly="readonly"
                            ...
                            <div class="has-success">
                             ...
                             <div class="has-success">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <span>
                                     <select id="f_addr_group" class="selector" style="width: 13em;height: 2em;border:1px solid green;"
                                             onchange="basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfo_common.saveBtnIsEffective()"></select>
                                     <span id="trunk_right"></span></span>
                                </div>
                            </div>
                         </div>
                         <div  class="vertical-timeline-block eqTreeAttrLineWidth">
                            <div class="has-success">
                             ...
                             <div class="has-success">
                                 ...
                                 <div class="col-sm-4">
                                     <input type="text" id="f_belong_iprouter"  value="${returnObject.data.F_BELONG_IPROUTER}" class="form-control"
                                            onchange="basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfo_common.saveBtnIsEffective()">
                                 </div>
                             </div>
                         </div>
                               <br/> <br/>
                                <div style="margin-left: 66%;margin-top: 5em;">
                                    <button id="saveBtn" class="btn btn-primary" type="submit"
                                            onclick="basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfo.infoChanged()">应用</button>
                                </div>
...
var basedatamanage_eqmanage_eqconfiguration_sbdyAttrInfo = (function($,window, document, undefined) {
	...
	//通信地址
	function changeAddr(){
		/*var sel = $("#f_addr_selected").val();
		if(sel!=null &&sel!=""){
			$("#trunk_right").text(sel.substring(sel.indexOf("."),sel.length));
		}*/
		var selSpinner = $("#f_addr_selected").val().split(".")[0];
		for (var i = 1; i < 256; i++) {
			...
			if (eval($("#saveBtn").attr("name"))) {
				$.ajax({
					...
					data : JSON.stringify({
                        ...
                        f_belong_iprouter   : $("#f_belong_iprouter").val(),//归属系统
				...
				$.ajax({//新增属性节点时
					...
					type : "post",
					data : JSON.stringify({
                        f_sbid 	            : $("#f_id").val(),//设备树id
                        TabName             : "BES_COUPLER",
                        f_sys_name          : $("#f_sys_name").val(),//名称
                        f_nick_name         : $("#f_nick_name").val(),//别名
                        f_type_coupler      : "0",// 0:干线
                        f_azwz              : $("#f_azwz").val(),//安装地址
                        f_addr              : $("#f_addr_group option:checked").val(),//通信地址
