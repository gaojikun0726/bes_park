...
public class InterfaceAccessUtil {
    ...
    private static final Logger log = LogManager.getLogger(InterfaceAccessUtil.class);
     ...
     * @return
     */
    public static String doGetWithException(String path) throws IOException{
        String result = "";
...
////            e.printStackTrace();
//            log.error("http请求报错："+e.getMessage());
//        } finally {
        try {
            // 释放资源
//                if (httpClient != null) {
...
//                e.printStackTrace();
            log.error("http请求-释放资源报错："+e.getMessage());
        }
//        }
        return result;
    }
