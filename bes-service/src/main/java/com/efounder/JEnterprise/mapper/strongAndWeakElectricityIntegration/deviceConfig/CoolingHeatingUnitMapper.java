 ...
 */
@Mapper
public interface CoolingHeatingUnitMapper {

    void insert(CoolingHeatingUnitModel coolingHeatingUnitModel);

    List<Object> findList(CoolingHeatingUnitModel coolingHeatingUnitModel);

    void update(CoolingHeatingUnitModel coolingHeatingUnitModel);

    void delete(Integer id);

    List<Object> coolingHeatingUnit (CoolingHeatingUnitModel coolingHeatingUnitModel);
     ...
     *
     */
    List<Map<String,Object>> findlistcommonconfig(CoolingHeatingUnitModel chum);
    /**
     *
     ...
     *
     */
    List<Map<String, Object>> findlistcommonconfig_top(CoolingHeatingUnitModel chum);
