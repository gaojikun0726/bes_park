package com.efounder.JEnterprise.timer.service.impl;

import com.efounder.JEnterprise.domain.SysJob;
import com.efounder.JEnterprise.timer.mapper.PSysJobMapper;
 ...
 */
@Service
public class PSysJobServiceImpl implements PSysJobService
{
    @Autowired
    private Scheduler scheduler;

    @Resource
    private PSysJobMapper jobMapper;
...
//        job.setStatus(ScheduleConstants.Status.PAUSE.getValue());
    ...
    public Map queryList(Map<String, Object> map, Integer pageNumber, Integer pageSize) {
        ...
        List<SysJob> list = jobMapper.queryList(map);
        PageInfo<SysJob> page = new PageInfo<>(list);
