 ...
 */
@Controller
@RequestMapping(value = "/view/realtimemonitoring/BESPfjk")
public class BESPfjkController {
	private static final Logger log = LoggerFactory.getLogger(BESPfjkController.class);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/pfjk", method = RequestMethod.GET)
	public String getZnzm(ModelMap map) {
		log.info("获取信息---->排风监控");
		return "view/realtimemonitoring/pfjk";
	}
	/**
	 * 选中节点加载不同的监控界面
	 * @param variableUrl
...
//		map.put("test", "aaaa");
		...
		return "view/realtimemonitoring/pfjk/" + variableUrl;
	}
}
