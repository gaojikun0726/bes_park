...
/**
 * @author 杨超
 * @version 创建时间：2018年11月19日 上午9:26:25
 * @parameter 导出excel工具类
 * @version 1.0
 */
public class BESExportExcel {
	...
	// 构造方法，传入要导出的数据
	public BESExportExcel(String realfile, String title, String[] rowName, List<Object[]> dataList) {
