...
*/
public class Task extends Object implements Runnable,KeyValue {
  ...
  protected java.util.Map attMap = null;
  public Object getValue(Object key, Object def) {
    if ( attMap == null ) return def;
    Object res = attMap.get(key);
    return res==null?def:res;
  }

  public void setValue(Object key, Object val) {
    if ( attMap == null ) attMap = new java.util.HashMap();
    attMap.put(key,val);
  }
